...
void main() {
  ...
  for (final file in featureDir
    ...
    final relativeImport = p.relative(file.path, from: 'lib').replaceAll(".g", "");
    final importAlias =
        p.basenameWithoutExtension(file.path).replaceAll(".g", "");

    buffer.writeln('import \'package:$packageName/$relativeImport\' as $importAlias;');
